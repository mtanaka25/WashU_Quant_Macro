...
model_Qe1.solve_question_d(K2_guess = K2_guess)

model_Qe2 = TwoPeriodKrusellSmith(k1_min = 0.0, k1_max = 0.3)
model_Qe2.solve_question_d(K2_guess = K2_guess)
...
model_Qf1 = TwoPeriodKrusellSmith(eps2_min = 0.9,
                                  eps2_max = 1.1)
model_Qf1.solve_question_d(K2_guess = K2_guess)

model_Qf2 = TwoPeriodKrusellSmith(eps2_min = 0.9,
                                  eps2_max = 1.1,
                                  k1_min = 0.05,
                                  k1_max = 0.25)
model_Qf2.solve_question_d(K2_guess = K2_guess)

model_Qf3 = TwoPeriodKrusellSmith(eps2_min = 0.9,
                                  eps2_max = 1.1,
                                  k1_min = 0.00,
                                  k1_max = 0.30)
model_Qf3.solve_question_d(K2_guess = K2_guess)
...
model_Qg1.solve_question_d(K2_guess = K2_guess)

model_Qg2 = TwoPeriodKrusellSmith(k2_min = 0.0,
                                  k1_min = 0.05,
                                  k1_max = 0.25)
model_Qg2.solve_question_d(K2_guess = K2_guess)

model_Qg3 = TwoPeriodKrusellSmith(k2_min = 0.0,
                                  k1_min = 0.0,
                                  k1_max = 0.3)
model_Qg3.solve_question_d(K2_guess = K2_guess)
...
model_Qg4 = TwoPeriodKrusellSmith(k2_min = 0.0,
                                  eps2_min = 0.9,
                                  eps2_max = 1.1)
model_Qg4.solve_question_d(K2_guess = K2_guess)
...
model_Qg5 = TwoPeriodKrusellSmith(k2_min = 0.0,
                                  ...
                                  k1_min = 0.05,
                                  k1_max = 0.25)
model_Qg5.solve_question_d(K2_guess = K2_guess)
...
model_Qg6 = TwoPeriodKrusellSmith(k2_min = 0.0,
                                  ...
                                  k1_min = 0.0,
                                  k1_max = 0.3)
model_Qg6.solve_question_d(K2_guess = K2_guess)
